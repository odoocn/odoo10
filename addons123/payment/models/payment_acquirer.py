...
class PaymentTransaction(models.Model):
    ...
    # ===zhy
    @api.model
    def _get_default_partner_lang(self):
        return self.env['res.lang'].get_installed()[0][0]
    # ---zhy
    ...
    # ===zhy
    partner_lang = fields.Selection(_lang_get, 'Language', default=_get_default_partner_lang)
    # ---zhy
