...
class AccountAccount(models.Model):
    ...
    # ===zhy
    balance_direct = fields.Selection([('debit', u'借方'), ('credit', u'贷方')], string=u'余额方向',
                                      default='debit', required=True)
    # ---zhy
    _sql_constraints = [
...
class AccountTax(models.Model):
    ...
    # ===zhy 默认变更
    price_include = fields.Boolean(string='Included in Price', default=True,
        help="Check this if the price you use on the product and invoices includes this tax.")
    include_base_amount = fields.Boolean(string='Affect Base of Subsequent Taxes', default=True,
    ...
    #change mlp =====================================================
    @api.multi
    def compute_all_2(self, price_total,price_unit, currency=None, quantity=1.0, product=None, partner=None):
        """ Returns all information required to apply taxes (in self + their children in case of a tax goup).
            We consider the sequence of the parent for group of taxes.
                Eg. considering letters as taxes and alphabetic order as sequence :
                [G, B([A, D, F]), E, C] will be computed as [A, D, F, C, E, G]
        ...
        total_excluded = total_included = base = round(price_total, prec)
