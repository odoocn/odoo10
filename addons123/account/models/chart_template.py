...
class AccountAccountTemplate(models.Model):
    ...
    # ===zhy
    balance_direct = fields.Selection([('credit', u'借方'), ('debit', u'贷方')], string=u'余额方向',
    ...
    def generate_account(self, tax_template_ref, acc_template_ref, code_digits, company):
        ...
        for account_template in acc_template:
            ...
            vals = {
                ...
                'balance_direct': account_template.balance_direct,# ===zhy
...
class AccountTaxTemplate(models.Model):
    ...
    include_base_amount = fields.Boolean(string='Affect Subsequent Taxes', default=True,
