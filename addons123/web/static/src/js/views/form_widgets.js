    ...
    init: function() {
        ...
        switch (this.options["terminology"]) {
            ...
            case "archive":
                ...
                break;
            case "undone":
                this.string_true = _t("待办");
                this.hover_true = _t("待办");
                this.string_false = _t("已完成");
                this.hover_false = _t("已完成");
                break;
            case "error_done":
                this.string_true = _t("已处理");
                this.hover_true = _t("已处理");
                this.string_false = _t("未处理");
                this.hover_false = _t("处理");
                break;
            default:
