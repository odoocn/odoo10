...
class DAReportSubsidiaryLedger(models.AbstractModel):
    _name = 'report.drise_advanced.report_subsidiaryledger'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('drise_advanced.report_subsidiaryledger', docargs)
