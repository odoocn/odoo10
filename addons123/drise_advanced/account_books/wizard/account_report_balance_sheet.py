...
class DAAccountReportBalanceSheet(models.TransientModel):
    ...
    journal_ids = fields.Many2many('account.journal', 'account_report_balance_sheet_journal_rel', 'account_id',
    ...
    def _print_report(self, data):
        ...
        return self.env['report'].with_context(landscape=True).get_action(records,
                                                                          'drise_advanced.report_balancesheet',
                                                                          data=data)
